    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_customer', models.BooleanField(default=False, verbose_name='Является клиентом')),
                ('is_provider', models.BooleanField(default=False, verbose_name='Является провайдером')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to='admin-news-images/', verbose_name='Картинка новости')),
                ('category', models.CharField(choices=[('F', 'Возможности'), ('TP', 'Условия партнерства')], verbose_name='Категория новости')),
