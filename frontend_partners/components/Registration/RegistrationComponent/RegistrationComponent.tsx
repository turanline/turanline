...
export default function Provider({ nextStep }: { nextStep: () => void }) {
  ...
  const [selectPhoneRegistration, setSelectPhoneRegistration] =
    useState<string>("+90");
  ...
  const selectClassName = {
    ...
    base: "w-[74px] h-[50px]",
    trigger:
      "border-black rounded-md rounded-r-none shadow-none w-[74px] h-[50px] border-1 border-r-0",
  };
    ...
    try {
      ...
      const requestBody: IPostRegistrationProvider = {
        user: {
          ...
          password,
          email: "",
          phone_number: (selectPhoneRegistration + phone_number).replace(
            /[^\d+]/g,
            ""
          ),
        },
    ...
    <div className="first-stage_wrapper">
      <div className="first-stage_content">
        <div className="first-stage_header">
          <h3 className="first-stage_title">{translate.registrationTitle}</h3>
          ...
          <div className="provider-stages">
            ...
            <p className="provider-stages-text">
              {translate.registrationStage} 2/4
            </p>
          </div>
        </div>
            ...
            <div className="provider-form-left">
              <label htmlFor="#" className="form-label">
                ...
                <Select
                  ...
                  placeholder={translate.registartionCountryLabel}
                ...
                <p className="label-county-text">
                  {translate.registrationCountryText}
                </p>
              </label>
