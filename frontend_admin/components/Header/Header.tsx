...
import {
  ...
  PROVIDER_PAYMENTS_ROUTE,
  PROVIDER_PRODUCTS_ROUTE,
  PROVIDER_SUPPLIERS_ROUTE,
  PROVIDER_USERS_ROUTE,
  PROVIDER_TARIFF_ROUTE,
...
export const Header = () => {
  ...
  const linksArray = [
    ...
    {
      route: PROVIDER_PAYMENTS_ROUTE,
      value: translate.headerPaymentsPage,
    },
    {
      route: PROVIDER_SUPPLIERS_ROUTE,
      value: translate.headerSuppliersPage,
    },
    {
      route: PROVIDER_USERS_ROUTE,
      value: translate.headerUsersPage,
    },
    // {
    //   route: PROVIDER_TARIFF_ROUTE,
    //   value: translate.headerTariffPage,
    // },
  ];
